...
# Libraries --------------------------------------------------------------------
library(readr)# Used in importing CSV
library(stringr)# String manipulations used in filenames
library(dplyr) # Data transformation functions like, select, mutate etc
library(ggplot2) # The main graphing library
